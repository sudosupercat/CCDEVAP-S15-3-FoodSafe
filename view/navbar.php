            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-items">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <?php foreach($navItems as $navItem) echo $navItem; ?>
                    </ul>
                </div>
            </div>
        </nav>
...
<!-- function showNavBar(){
    ...
    if(path.includes("/admin/")){
        ...
        navItems = `
            ...
            <li class="nav-item"><a class="nav-link" href="${basePath}controller/inspector/inspectorReports.controller.php">Reports</a></li>
            <li class="nav-item"><a class="nav-link" href="${basePath}controller/logoutPage.controller.php"><span><i class="bi bi-box-arrow-right me-1"></i></span>Logout</a></li>
        `;
    }
